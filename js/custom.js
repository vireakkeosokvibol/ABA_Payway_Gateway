    ...
    if( jQuery("#aba_is_enable").val() != "no" ){
        ...
        if( aba_enable_payment != '' && typeof aba_enable_payment != 'undefined'){
            ...
            if( jQuery.inArray( "credit_debit", aba_enable_payments )!= -1 ){
                var html_payment = prepare_payment_elem("aba_payway_aim_card", "Credit/Debit Card", "Pay with Credit/Debit Card", '<img class="payway_payment_logo" src="'+jQuery("#aba_logo_all_cards").val()+'" alt="ABA Pay">');
